...
describe("replacePlaceholdersWithFolderContents", () => {
  ...
  test("should replace placeholders with folder contents", () => {
    ...
    expect(replacePlaceholdersWithFolderContents(input)).toMatchInlineSnapshot(`
  ...
  test("should handle input without placeholders", () => {
    ...
    expect(replacePlaceholdersWithFolderContents(input)).toBe(input);
  });
  ...
  test("should handle empty folders gracefully", () => {
    ...
    expect(replacePlaceholdersWithFolderContents(input)).toBe(expectedOutput);
  });
